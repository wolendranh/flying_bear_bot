...
def quote(bot, update):
    try:
        ...
        if stripped_stop_word:
            ...
            bot.sendMessage(update.message.chat_id, text='Stop word missing. Please provide stop word text after `/quote` command! Thanks!')
    except Exception as e:
        logger.exception('Faile to store quote. Error', exc_info=e)
